      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-14">
          ...
          <div className="hidden space-x-10 justify-end md:flex md:flex-1 lg:w-0">
            <Link
              href="#"
              className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-green-400 px-4 py-2 text-xl font-medium text-white shadow-sm hover:bg-indigo-700"
            >
              Contact
            </Link>
          </div>
